...
<div class="bg-gray-50 dark:bg-gray-900">
    <!-- Carrusel mejorado para talleres deportivos -->
    <div id="sports-carousel" class="relative w-full" data-carousel="slide">
        ...
        <div class="relative h-64 sm:h-80 md:h-96 overflow-hidden rounded-lg">
            ...
            <div class="duration-700 ease-in-out absolute inset-0" data-carousel-item>
                <div class="relative w-full h-full">
                    <div class="absolute bottom-0 left-0 right-0 bg-black bg-opacity-50 text-white p-4">
                        <h3 class="text-xl font-bold">Taller de Fútbol</h3>
                        <p>Aprende técnicas profesionales y mejora tu juego</p>
                    </div>
                    <img src="/image/fuchi.jpg" class="w-full h-full object-cover" alt="Taller de Fútbol">
                </div>
            </div>
            ...
            <div class="duration-700 ease-in-out absolute inset-0" data-carousel-item>
                <div class="relative w-full h-full">
                    <div class="absolute bottom-0 left-0 right-0 bg-black bg-opacity-50 text-white p-4">
                        <h3 class="text-xl font-bold">Taller de Voleibol</h3>
                        <p>Domina los fundamentos y trabajo en equipo</p>
                    </div>
                    <img src="/image/yogar.jpg" class="w-full h-full object-cover" alt="Taller de Voleibol">
                </div>
            </div>
            ...
            <div class="duration-700 ease-in-out absolute inset-0" data-carousel-item>
                <div class="relative w-full h-full">
                    <div class="absolute bottom-0 left-0 right-0 bg-black bg-opacity-50 text-white p-4">
                        <h3 class="text-xl font-bold">Taller de Baloncesto</h3>
                        <p>Desarrolla tus habilidades de dribbling y tiros</p>
                    </div>
                    <img src="/image/basket.jpg" class="w-full h-full object-cover" alt="Taller de Baloncesto">
                </div>
            </div>
        </div>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            ...
            <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Selecciona tu taller deportivo: Fútbol, Baloncesto o Voleibol</p>
            
            <form action="#" class="space-y-8">
                <div>
                    <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Correo electrónico</label>
                    <input type="email" id="email" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="alumno@udg.mx" required>
                </div>
    ...
    <div class="grid mb-8 border border-gray-200 rounded-lg shadow-xs dark:border-gray-700 md:mb-12 md:grid-cols-2 bg-white dark:bg-gray-800">
        ...
        <figure class="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-t-lg md:rounded-t-none md:rounded-ss-lg md:border-e dark:bg-gray-800 dark:border-gray-700">
            <blockquote class="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Excelente entrenamiento</h3>
                <p class="my-4">El taller de fútbol mejoró mi técnica y condición física notablemente</p>
            </blockquote>
            <figcaption class="flex items-center justify-center">
                ...
                <div class="space-y-0.5 font-medium dark:text-white text-left rtl:text-right ms-3">
                    ...
                    <div class="text-sm text-gray-500 dark:text-gray-400">Estudiante de Educación Física</div>
                </div>
            </figcaption>    
        </figure>
        ...
        <figure class="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 md:rounded-se-lg dark:bg-gray-800 dark:border-gray-700">
            <blockquote class="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                ...
                <p class="my-4">Las estrategias de baloncesto que aprendí han elevado mi nivel de juego</p>
            </blockquote>
            <figcaption class="flex items-center justify-center">
        ...
        <figure class="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 md:rounded-es-lg md:border-b-0 md:border-e dark:bg-gray-800 dark:border-gray-700">
            <blockquote class="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Increíble experiencia</h3>
                <p class="my-4">El taller de voleibol superó mis expectativas, los entrenadores son excelentes</p>
            </blockquote>
            <figcaption class="flex items-center justify-center">
        ...
        <figure class="flex flex-col items-center justify-center p-8 text-center bg-white border-gray-200 rounded-b-lg md:rounded-se-lg dark:bg-gray-800 dark:border-gray-700">
            <blockquote class="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Bueno pero puede mejorar</h3>
                <p class="my-4">Los talleres son buenos, pero sugiero más horarios disponibles</p>
            </blockquote>
            <figcaption class="flex items-center justify-center">
