...
<div class="bg-gray-50 dark:bg-gray-900">
    <!-- Carrusel mejorado para talleres de desarrollo personal -->
    <div id="personal-growth-carousel" class="relative w-full" data-carousel="slide">
        <!-- Contenedor del carrusel con altura adaptable -->
        <div class="relative h-64 sm:h-80 md:h-96 overflow-hidden rounded-lg">
            <!-- Item 1 - Autocrecimiento -->
            <div class="duration-700 ease-in-out absolute inset-0" data-carousel-item>
                <div class="relative w-full h-full">
                    <div class="absolute bottom-0 left-0 right-0 bg-black bg-opacity-50 text-white p-4">
                        <h3 class="text-xl font-bold">Taller de Autocrecimiento</h3>
                        <p>Descubre tu potencial y desarrolla tus habilidades personales</p>
                    </div>
                    <img src="/image/person.jpg" class="w-full h-full object-cover" alt="Taller de Autocrecimiento Personal">
                </div>
            </div>
            ...
            <div class="duration-700 ease-in-out absolute inset-0" data-carousel-item>
                <div class="relative w-full h-full">
                    <div class="absolute bottom-0 left-0 right-0 bg-black bg-opacity-50 text-white p-4">
                        <h3 class="text-xl font-bold">Taller de Relajación</h3>
                        <p>Aprende técnicas para manejar el estrés y mejorar tu bienestar</p>
                    </div>
                    <img src="/image/perso.jpg" class="w-full h-full object-cover" alt="Taller de Relajación">
                </div>
            </div>
            
            <!-- Item 3 - Proyecto de Vida -->
            <div class="duration-700 ease-in-out absolute inset-0" data-carousel-item>
                <div class="relative w-full h-full">
                    <div class="absolute bottom-0 left-0 right-0 bg-black bg-opacity-50 text-white p-4">
                        <h3 class="text-xl font-bold">Proyecto de Vida</h3>
                        <p>Define tus metas y crea un plan para alcanzar tus sueños</p>
                    </div>
                    <img src="/image/personal.jpg" class="w-full h-full object-cover" alt="Taller de Proyecto de Vida">
                </div>
            </div>
        </div>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            ...
            <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Elige tu taller de desarrollo personal: Autocrecimiento, Relajación o Proyecto de Vida</p>
            ...
            <form action="#" class="space-y-8">
                ...
                <div>
                    ...
                    <select id="taller" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <option value="autocrecimiento">Autocrecimiento Personal</option>
                        <option value="relajacion">Técnicas de Relajación</option>
                        <option value="proyecto-vida">Proyecto de Vida</option>
                    </select>
                </div>
                
                <div class="sm:col-span-2">
                    <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Sugerencias o expectativas</label>
                    <textarea id="message" rows="6" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="¿Qué esperas aprender en este taller?"></textarea>
                </div>
    ...
    <div class="grid mb-8 border border-gray-200 rounded-lg shadow-xs dark:border-gray-700 md:mb-12 md:grid-cols-2 bg-white dark:bg-gray-800">
        ...
        <figure class="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-t-lg md:rounded-t-none md:rounded-ss-lg md:border-e dark:bg-gray-800 dark:border-gray-700">
            <blockquote class="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                ...
                <p class="my-4">El taller de autocrecimiento me ayudó a descubrir habilidades que no sabía que tenía</p>
            </blockquote>
            <figcaption class="flex items-center justify-center">
                ...
                <div class="space-y-0.5 font-medium dark:text-white text-left rtl:text-right ms-3">
                    ...
                    <div class="text-sm text-gray-500 dark:text-gray-400">Psicología</div>
                </div>
            </figcaption>    
        </figure>
        ...
        <figure class="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 md:rounded-se-lg dark:bg-gray-800 dark:border-gray-700">
            <blockquote class="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Bienestar alcanzado</h3>
                <p class="my-4">Las técnicas de relajación aprendidas han mejorado mi calidad de vida significativamente</p>
            </blockquote>
            <figcaption class="flex items-center justify-center">
        ...
        <figure class="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 md:rounded-es-lg md:border-b-0 md:border-e dark:bg-gray-800 dark:border-gray-700">
            <blockquote class="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Futuro claro</h3>
                <p class="my-4">El taller de proyecto de vida me dio las herramientas para planear mi carrera profesional</p>
            </blockquote>
            <figcaption class="flex items-center justify-center">
                ...
                <div class="space-y-0.5 font-medium dark:text-white text-left rtl:text-right ms-3">
                    ...
                    <div class="text-sm text-gray-500 dark:text-gray-400">Ingeniería</div>
                </div>
            </figcaption>    
        </figure>
        ...
        <figure class="flex flex-col items-center justify-center p-8 text-center bg-white border-gray-200 rounded-b-lg md:rounded-se-lg dark:bg-gray-800 dark:border-gray-700">
            <blockquote class="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Sugerencias constructivas</h3>
                <p class="my-4">Los talleres son buenos pero podrían incluir más seguimiento después de finalizar</p>
            </blockquote>
            <figcaption class="flex items-center justify-center">
